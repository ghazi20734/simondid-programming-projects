...
import com.badlogic.agd.KeyEvent.KeyEventType;
...
public abstract class Game extends Activity implements Runnable, OnKeyListener, SensorEventListener {
    ...
    private List<com.badlogic.agd.TouchEvent> touchEvents = new ArrayList<com.badlogic.agd.TouchEvent>();
    /** the buffer of TouchEvent instances, filled on the UI thread and copied to the touchEvents list on the main loop thread **/
    private List<com.badlogic.agd.TouchEvent> touchEventBuffer = new ArrayList<com.badlogic.agd.TouchEvent>();
    ...
    /** 
     * @return the list of {@link com.badlogic.agd.KeyEvent}s since the last frame.
     */
     ...
     */
    public List<com.badlogic.agd.TouchEvent> getTouchEvents() {
        return touchEvents;
    }
